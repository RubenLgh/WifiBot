...
/**
 * @brief MainWindow::calculVitesse
 * @param odo
 * @param estGauche définit quelle roue est concernée
 * @return différence entre l'odométrie donnée en parametre et l'odometrie recue dans le message précédent
 */
...
void MainWindow::leftDown()
{
    robot.DataToSend.resize(9);
    /**
     * le capteur étant cassé , il capte toujours un obstacle
